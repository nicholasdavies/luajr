...
alloc_bigr = lua_func("function(x) local x = luajr.numeric_r(2^34*1.5, 0) return x end", "&.")
alloc_bigr()

alloc_bigv = lua_func("function(x) local x = luajr.numeric(2^38, 0) return x end", "&.")
alloc_bigv()
