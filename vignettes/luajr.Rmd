...
Here we are comparing two different methods of running a parameter sweep of the
logistic map, a chaotic dynamical system popularized by Bob May in a 
[1976 Nature article](https://sites.ifi.unicamp.br/aguiar/files/2014/10/May-Nature-1976.pdf).
...
The times taken by each function are as follows:
