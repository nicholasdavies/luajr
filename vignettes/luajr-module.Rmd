...
- [Parallel processing](#parallel) features of the `luajr` module. /ncores, workers/
- [Utility functions](#utility) for `luajr`. /debugger, luajr.from_sexp, luajr.to_sexp/
...
```lua
dm = luajr.datamatrix_r(nrow, ncol, names, init)
```
