...
API_FUNCTION(lua_State*, luajr_newstate)
API_FUNCTION(void, luajr_reset)
...
API_FUNCTION(void, luajr_pcall, lua_State* L, int nargs, int nresults, const char* funcdesc)
