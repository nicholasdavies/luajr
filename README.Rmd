...
luajr provides an R interface to Mike Pall's [LuaJIT](<https://luajit.org>), a just-in-time compiler for the [Lua scripting language](<https://www.lua.org>). It allows users to run Lua code from R.
...
## Under development
luajr is under **early development**. As such, it has not yet been tested to work on all platforms, and the interface and behaviour of the package is subject to change without notice.
